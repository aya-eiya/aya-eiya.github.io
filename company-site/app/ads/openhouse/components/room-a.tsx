...
export function RoomASlideEn(): ReactElement {
  return (
    <div className="relative flex flex-col h-full gap-2">
      <div className="relative h-2/3 overflow-hidden rounded-lg">
        <img
