...
export const DetailTexts: Record<Room, string> = {
  R_1fL:
    '庭に面した離れの一室に加え、収納が豊富なサービスルームがついたお部屋です。３名までルームシェアができます',
  R_1fC: '管理人室として利用しています',
  R_1fJ:
    '唯一の和室です。作業に適した書斎がついているお部屋となります。３名までルームシェアができます',
  R_2fA:
    '2階の個室です。小学校のグラウンドを見下ろす大きなベランダがついています。２名までルームシェアができます',
  R_2fB:
    '2階の個室です。小学校のグラウンドを見下ろす大きなベランダがついています。２名までルームシェアができます',
  M_2fDomi:
    '共用のオフィススペースです。懸垂器などのトレーニング器具もあり、外部の方もコワーキングスペースとして月額契約で利用できます',
  M_1fDomi:
    '男性用のドミトリーです。2段ベッドを一床と収納タンスが占有です。一室を最大6名で共有します',
  F_2fDomi:
    '女性用のドミトリーです。同施設内に別途玄関を備えた一室を最大4名で共有します。女性ドミトリー入居者専用の洗濯機、浴室、トイレ、ベランダ、キッチンルームの備えがあります。他の部屋との共用の設備もお使いいただけます',
}
